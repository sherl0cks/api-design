   ...
   stage('Code Gen') {
      dir( 'code-gen' ){
          ...
          dir ( 'target/java-client' ){
              sh "'${mvnHome}/bin/mvn' clean deploy -DaltDeploymentRepository=nexus::default::http://nexus3.artifact-repository-dev.svc.cluster.local:8081/repository/labs-snapshots"
          }
